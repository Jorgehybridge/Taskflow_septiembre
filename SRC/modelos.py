...
class Proyecto: #Esta clase nos ayudará a diferenciar entre proyectos para universidad, clases, trabajo, etc.
    """
    ...
    def id(self): #propiedad 1, el getter obtiene el dato
        """Getter para acceder al ID de forma limpia (proyecto.id)."""
        return self._id

    @id.setter #propiedad 2 #el setter asigna el dato
    def id(self, valor):
